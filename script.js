...
class MinePredictor {
    ...
    handlePredict() {
        ...
        if (mineAmount > this.totalCells - 1) {
            alert(`Mine amount cannot be ${this.totalCells} or more! Maximum is ${this.totalCells - 1} mines for a ${this.gridSize}×${this.gridSize} grid.`);
            return;
        }
